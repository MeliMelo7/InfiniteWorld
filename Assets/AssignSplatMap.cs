...
//				splatWeights[2] = (1.0f - Mathf.Clamp01(steepness*steepness/(terrainData.heightmapHeight/5.0f))) *1.5f;
//
//				// Texture[3] increases with height but only on surfaces facing positive Z axis 
//				splatWeights[3] = height * Mathf.Clamp01(normal.z);
//
//				//Texture[4] increases with height no matter the way the surface is facing
//				if(height > (terrainData.heightmapHeight/10))
//				{
//					splatWeights[4] = height * 0.05f;
//				}
//				else
//				{
//					splatWeights[4] = 0;
...
//				//flat surface with high altitude
//				splatWeights[5] = (1.0f - Mathf.Clamp01(steepness*steepness/(terrainData.heightmapHeight/5.0f))) * height;
